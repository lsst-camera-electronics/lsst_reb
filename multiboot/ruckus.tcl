...
# Load Source Code
# loadSource -lib lsst_reb -path "$::DIR_PATH/rtl/multiboot_fsm.vhd"
...
# loadSource -lib lsst_reb -path "$::DIR_PATH/rtl/SpiFlashProgrammer.vhd"
loadSource -lib lsst_reb -path "$::DIR_PATH/rtl/SpiSerDes.vhd"

loadIpCore -path "$::DIR_PATH/ip_cores/bitfile_fifo_in/bitfile_fifo_in.xci"
