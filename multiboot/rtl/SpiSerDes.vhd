...
begin
  ...
  processTransferDone : process (inClk) is
  begin
  ...
  processSpiCsB : process (inClk) is
  begin
  ...
  processShiftCount : process (inClk) is
  begin
  ...
  processShiftData : process (inClk) is
  begin
  ...
  processSpiMosi : process (inClk) is
  begin
